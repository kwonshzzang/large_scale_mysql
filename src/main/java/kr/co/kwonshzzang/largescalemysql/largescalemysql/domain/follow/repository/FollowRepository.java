package kr.co.kwonshzzang.largescalemysql.largescalemysql.domain.follow.repository;
...
public class FollowRepository {
    ...
    private final static RowMapper<Follow> FOLLOW_ROW_MAPPER = (ResultSet rs, int rowNum) -> Follow.builder()
            .id(rs.getLong("id"))
    ...
    public List<Follow> findAllByFromMemberId(Long fromMemberId) {
        ...
        return jdbcTemplate.query(sql, param, FOLLOW_ROW_MAPPER);
    }
